...
const LightBox = ({ imageSrc, altText, handleModalClose, reklam,newimages }) => {
  ...
  return (
    ...
    >
      <div className=" w-full h-full  bg-white z-101 flex flex-col  items-center border-2 border-red-800">
        ...
        <div className="flex  justify-center my-20 border-0 border-red-700 w-full h-full m-0 p-0">
